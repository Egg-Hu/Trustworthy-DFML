...
import csv
import os
# data_path='/home/hzx/fcil/dfmeta/DFL2Ldata/mnist/mnist_png'
# savedir = '/home/hzx/fcil/dfmeta/DFL2Ldata/mnist/split/'
script_dir = os.path.dirname(os.path.abspath(__file__)) 
parent_dir = os.path.dirname(script_dir)
data_path = os.path.join(parent_dir, 'DFL2Ldata/mnist/mnist_png')
savedir = os.path.join(parent_dir, 'DFL2Ldata/mnist/split/')
