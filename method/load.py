...
class LOAD():
    def __init__(self,args):
        ...
        #self.model.load_state_dict(torch.load('/home/hzx/fcil/dfmlmd/checkpoints6/SAFE/purer_protonet_deepinv/miniimagenet_conv4_conv4_100APINum_0.0oodP_0.0fakeP_-1fakefrom_ProtoNet_5wPre_1S_15Q_0.001lr_4TaskBatch_13CandiBatch_0.01Glr_/bestmodel_4200it.pth'))
        self.model.load_state_dict(torch.load('/home/hzx/fcil/dfmlmd/checkpoints6/SAFE/purer_anil_deepinv/miniimagenet_conv4_conv4_100APINum_0.0oodP_0.0fakeP_-1fakefrom_ANIL_5wPre_1S_15Q_5trainStep10testStep0.01innerlr_0.001outerlr_4Taskbatch_13CandiBatch_0.01Glr_/bestmodel_4600it.pth'))
