...
class Average():
    def __init__(self,args):
        ...
        self.checkpoints_path = './checkpoints_average/' + feature1 + '/' + feature2
    ...
    def train_loop(self):
        ...
        self.logger.info('[average], [TestAcc]:{} +- {}.'.format(test_acc_avg, test_pm))
    ...
    def get_average(self):
        ...
        for pretrain_id in range(self.args.APInum):
            pretrained_model_list.append(torch.load('./pretrained/{}_{}/{}way/model/model_specific_acc_{}.pth'.format(self.args.dataset, self.args.pre_backbone, self.args.way_pretrain,pretrain_id))['teacher'])
        model_maml_dic = FedAvg(pretrained_model_list)
        self.model.load_state_dict(model_maml_dic)
        # del model_maml_dic
def FedAvg(w):
