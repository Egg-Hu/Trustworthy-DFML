...
import numpy as np
# SPLIT_PATH = osp.join('/home/hzx/fcil/dfmeta/DFL2Ldata/aircraft/split')
script_dir = os.path.dirname(os.path.abspath(__file__)) 
parent_dir = os.path.dirname(script_dir)
SPLIT_PATH = os.path.join(parent_dir, 'DFL2Ldata/aircraft/split')
...
class aircraft_Specific(Dataset):
    """ Usage:
    """
